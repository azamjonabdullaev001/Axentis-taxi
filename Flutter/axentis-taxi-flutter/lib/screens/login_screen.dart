          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: Text('Axentis Taxi',
                      style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: theme.primary)),
                ),
                ...
                Row(
                  ...
                  children: [
                    Text(t.t('noAccount'), style: TextStyle(color: theme.textSecondary)),
