  ...
  <div class="layout">
    <aside class="sidebar">
      <div class="sidebar-logo">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="#FFCC00" style="flex-shrink:0">
...
.sidebar-logo {
  ...
  font-size: 17px; font-weight: 800; color: #FFCC00;
  padding: 0 24px 28px;
...
.logout-btn:hover { background: #2a2a2a; color: #f44336; }
.main-content {
  margin-left: 240px;
  flex: 1;
  padding: 32px;
