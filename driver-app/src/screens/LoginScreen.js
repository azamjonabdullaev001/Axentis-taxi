...
function makeStyles(colors) {
  return StyleSheet.create({
    ...
    phoneInput: { flex: 1, borderWidth: 1.5, borderRadius: 12, padding: 14, fontSize: 15 },
    ...
    btn: {
      backgroundColor: colors.primary, borderRadius: 14, padding: 16, alignItems: 'center', marginTop: 4,
      shadowColor: colors.primary,
